...
class _UpdateSignatureViewState extends State<UpdateSignatureView> {
  ...
  // التعديل الوحيد هنا (سطر واحد فقط)
  Widget _buildStrokeToolbar(BuildContext context) {
    return StateNotifierBuilder<ScribbleState>(
      stateNotifier: notifier as StateNotifier<ScribbleState>, // تم الحل هنا
  ...
  // التعديل الثاني والأخير هنا (سطر واحد فقط)
  ...
  Widget _buildColorButton(BuildContext context,
      {required Color color, required ScribbleState state}) {
  ...
  Widget _buildRedoButton(BuildContext context) {
    return FloatingActionButton.small(
      ...
      child: const Icon(Icons.redo_rounded, color: Colors.white),
    );
  }
