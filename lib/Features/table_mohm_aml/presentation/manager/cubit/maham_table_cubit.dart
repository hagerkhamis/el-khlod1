...
import '../../../domain/use_case/maham_table_use_case.dart';

part 'maham_table_state.dart';

class MahamTableCubit extends Cubit<MahamTableState> {
  MahamTableUseCase tableUseCase;
  MahamTableCubit(this.tableUseCase) : super(FetchInitial());
